...
const SuggestedFriendsCard = ({ avatar, name, mutualFriends }) => {
  return (
    <div className="w-[220px] bg-white rounded-md friendcard-shadow border border-gray-200 shadow-lg hover:shadow-xl transition-all">
      ...
      <div className="p-3 text-center">
        ...
        <div className="mt-2 flex flex-col gap-1">
          <button className="bg-blue-500 hover:bg-blue-600 text-white text-sm py-1 rounded-md">Thêm bạn bè</button>
